...
const ContactSection: React.FC<ContactSectionProps> = ({ onSubmit }) => {
  ...
  return (
    <section id="contact" className="py-16 bg-gray-50 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-72 h-72 bg-blue-100 rounded-full opacity-20 -mr-20 -mb-20"></div>
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray-700 max-w-2xl mx-auto">
            Have questions or ready to take the next step? Reach out to our team, and we'll get back to you within one business day.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            <div className="bg-white p-8 rounded-lg shadow-md mb-8">
              <h3 className="text-xl font-bold text-blue-800 mb-4">Our Office</h3>
            ...
            <div className="bg-white p-8 rounded-lg shadow-md">
              ...
              <p className="text-gray-700 mb-6">
                Follow us on social media for financial tips, industry news, and company updates.
              </p>
