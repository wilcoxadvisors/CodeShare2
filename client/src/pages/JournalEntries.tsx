...
function JournalEntries() {
  ...
  const columns = [
    ...
    { 
      ...
      type: "currency",
      render: (row) => {
        const totalDebit = row.lines?.reduce((sum, line) => sum + parseFloat(line.debit || 0), 0) || 0;
    ...
    { 
      ...
      type: "currency",
      render: (row) => {
        const totalCredit = row.lines?.reduce((sum, line) => sum + parseFloat(line.credit || 0), 0) || 0;
